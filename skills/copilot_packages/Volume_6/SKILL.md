---
name: master-skills-volume-6
description: "Master Quantitative Trading and Autonomous Agent Engineering Methodologies Volume 6 of 6."
---

# MASTER TRADING SKILLS - VOLUME 6 OF 6

> Comprehensive specialized engineering and quantitative trading methodologies.
> Volume 6 contains 185 unabridged skills (`supabase-performance-tuning` to `zigzag-pattern-classifier`).

## VOLUME TABLE OF CONTENTS

| # | Skill Name | Anchor Link | Bytes |
|---|---|---|---|
| 1 | `supabase-performance-tuning` | [supabase-performance-tuning](#skill-supabase-performance-tuning) | 13,099 |
| 2 | `supabase-reference-architecture` | [supabase-reference-architecture](#skill-supabase-reference-architecture) | 12,115 |
| 3 | `swift-protocol-di-testing` | [swift-protocol-di-testing](#skill-swift-protocol-di-testing) | 6,303 |
| 4 | `swiftui-performance-audit` | [swiftui-performance-audit](#skill-swiftui-performance-audit) | 5,477 |
| 5 | `swiftui-view-refactor` | [swiftui-view-refactor](#skill-swiftui-view-refactor) | 8,423 |
| 6 | `sync-profiles` | [sync-profiles](#skill-sync-profiles) | 2,147 |
| 7 | `sync-status` | [sync-status](#skill-sync-status) | 1,237 |
| 8 | `systematic-debugging` | [systematic-debugging](#skill-systematic-debugging) | 10,564 |
| 9 | `tailwind-patterns` | [tailwind-patterns](#skill-tailwind-patterns) | 7,234 |
| 10 | `tdd-orchestrator` | [tdd-orchestrator](#skill-tdd-orchestrator) | 10,799 |
| 11 | `tdd-repair` | [tdd-repair](#skill-tdd-repair) | 6,417 |
| 12 | `tdd-workflow` | [tdd-workflow](#skill-tdd-workflow) | 3,402 |
| 13 | `tdd-workflows-tdd-cycle` | [tdd-workflows-tdd-cycle](#skill-tdd-workflows-tdd-cycle) | 9,232 |
| 14 | `tdd-workflows-tdd-green` | [tdd-workflows-tdd-green](#skill-tdd-workflows-tdd-green) | 2,356 |
| 15 | `tdd-workflows-tdd-red` | [tdd-workflows-tdd-red](#skill-tdd-workflows-tdd-red) | 5,179 |
| 16 | `tdd-workflows-tdd-refactor` | [tdd-workflows-tdd-refactor](#skill-tdd-workflows-tdd-refactor) | 6,577 |
| 17 | `tdd-workflows` | [tdd-workflows](#skill-tdd-workflows) | 1,327 |
| 18 | `tdd` | [tdd](#skill-tdd) | 3,587 |
| 19 | `teach` | [teach](#skill-teach) | 9,646 |
| 20 | `techsmith-debug-bundle` | [techsmith-debug-bundle](#skill-techsmith-debug-bundle) | 1,860 |
| 21 | `techsmith-performance-tuning` | [techsmith-performance-tuning](#skill-techsmith-performance-tuning) | 1,890 |
| 22 | `techsmith-reference-architecture` | [techsmith-reference-architecture](#skill-techsmith-reference-architecture) | 1,910 |
| 23 | `temporal-python-pro` | [temporal-python-pro](#skill-temporal-python-pro) | 11,269 |
| 24 | `temporal-python-testing` | [temporal-python-testing](#skill-temporal-python-testing) | 5,803 |
| 25 | `tensorboard-visualizer` | [tensorboard-visualizer](#skill-tensorboard-visualizer) | 2,384 |
| 26 | `tensorflow-model-trainer` | [tensorflow-model-trainer](#skill-tensorflow-model-trainer) | 2,400 |
| 27 | `tensorflow-savedmodel-creator` | [tensorflow-savedmodel-creator](#skill-tensorflow-savedmodel-creator) | 2,450 |
| 28 | `tensorflow-serving-setup` | [tensorflow-serving-setup](#skill-tensorflow-serving-setup) | 2,391 |
| 29 | `terraform-state-manager` | [terraform-state-manager](#skill-terraform-state-manager) | 2,388 |
| 30 | `test-automator` | [test-automator](#skill-test-automator) | 11,675 |
| 31 | `test-data-builder` | [test-data-builder](#skill-test-data-builder) | 2,250 |
| 32 | `test-driven-development` | [test-driven-development](#skill-test-driven-development) | 10,623 |
| 33 | `test-error-states` | [test-error-states](#skill-test-error-states) | 4,533 |
| 34 | `test-fixing` | [test-fixing](#skill-test-fixing) | 3,553 |
| 35 | `test-framework-migration-skill` | [test-framework-migration-skill](#skill-test-framework-migration-skill) | 8,883 |
| 36 | `test-gaps` | [test-gaps](#skill-test-gaps) | 871 |
| 37 | `test-guard` | [test-guard](#skill-test-guard) | 8,418 |
| 38 | `test-naming-enforcer` | [test-naming-enforcer](#skill-test-naming-enforcer) | 2,284 |
| 39 | `test-organization-helper` | [test-organization-helper](#skill-test-organization-helper) | 2,326 |
| 40 | `test-parallelizer` | [test-parallelizer](#skill-test-parallelizer) | 2,255 |
| 41 | `test-retry-config` | [test-retry-config](#skill-test-retry-config) | 2,249 |
| 42 | `test-skill` | [test-skill](#skill-test-skill) | 1,565 |
| 43 | `testing-browser-compatibility` | [testing-browser-compatibility](#skill-testing-browser-compatibility) | 7,112 |
| 44 | `testing-load-balancers` | [testing-load-balancers](#skill-testing-load-balancers) | 6,387 |
| 45 | `testing-mobile-apps` | [testing-mobile-apps](#skill-testing-mobile-apps) | 5,768 |
| 46 | `testing-patterns` | [testing-patterns](#skill-testing-patterns) | 3,792 |
| 47 | `testing-qa` | [testing-qa](#skill-testing-qa) | 5,424 |
| 48 | `testing-visual-regression` | [testing-visual-regression](#skill-testing-visual-regression) | 5,299 |
| 49 | `testng-skill` | [testng-skill](#skill-testng-skill) | 5,548 |
| 50 | `thread-dump-analyzer` | [thread-dump-analyzer](#skill-thread-dump-analyzer) | 2,374 |
| 51 | `threat-detection` | [threat-detection](#skill-threat-detection) | 5,185 |
| 52 | `throughput-calculator` | [throughput-calculator](#skill-throughput-calculator) | 2,388 |
| 53 | `time-series-decomposer` | [time-series-decomposer](#skill-time-series-decomposer) | 2,360 |
| 54 | `to-questionnaire` | [to-questionnaire](#skill-to-questionnaire) | 2,958 |
| 55 | `to-spec` | [to-spec](#skill-to-spec) | 3,118 |
| 56 | `to-tickets` | [to-tickets](#skill-to-tickets) | 5,776 |
| 57 | `together-debug-bundle` | [together-debug-bundle](#skill-together-debug-bundle) | 1,540 |
| 58 | `together-performance-tuning` | [together-performance-tuning](#skill-together-performance-tuning) | 1,573 |
| 59 | `together-reference-architecture` | [together-reference-architecture](#skill-together-reference-architecture) | 6,533 |
| 60 | `torchscript-exporter` | [torchscript-exporter](#skill-torchscript-exporter) | 2,345 |
| 61 | `torchserve-config-generator` | [torchserve-config-generator](#skill-torchserve-config-generator) | 2,407 |
| 62 | `touch-feature` | [touch-feature](#skill-touch-feature) | 8,572 |
| 63 | `tracing-transitive-vulnerabilities` | [tracing-transitive-vulnerabilities](#skill-tracing-transitive-vulnerabilities) | 8,982 |
| 64 | `tracking-application-response-times` | [tracking-application-response-times](#skill-tracking-application-response-times) | 4,179 |
| 65 | `tracking-model-versions` | [tracking-model-versions](#skill-tracking-model-versions) | 5,384 |
| 66 | `tracking-regression-tests` | [tracking-regression-tests](#skill-tracking-regression-tests) | 5,533 |
| 67 | `tracking-resource-usage` | [tracking-resource-usage](#skill-tracking-resource-usage) | 4,875 |
| 68 | `tracking-service-reliability` | [tracking-service-reliability](#skill-tracking-service-reliability) | 4,153 |
| 69 | `trader-backtest` | [trader-backtest](#skill-trader-backtest) | 5,553 |
| 70 | `trader-cloud-backtest` | [trader-cloud-backtest](#skill-trader-cloud-backtest) | 7,377 |
| 71 | `trader-explain` | [trader-explain](#skill-trader-explain) | 8,224 |
| 72 | `trader-portfolio-cg` | [trader-portfolio-cg](#skill-trader-portfolio-cg) | 6,917 |
| 73 | `trader-portfolio` | [trader-portfolio](#skill-trader-portfolio) | 1,936 |
| 74 | `trader-regime` | [trader-regime](#skill-trader-regime) | 1,662 |
| 75 | `trader-risk` | [trader-risk](#skill-trader-risk) | 1,465 |
| 76 | `trader-signal` | [trader-signal](#skill-trader-signal) | 2,471 |
| 77 | `trader-train` | [trader-train](#skill-trader-train) | 1,624 |
| 78 | `train-test-splitter` | [train-test-splitter](#skill-train-test-splitter) | 2,302 |
| 79 | `training-machine-learning-models` | [training-machine-learning-models](#skill-training-machine-learning-models) | 4,170 |
| 80 | `triage` | [triage](#skill-triage) | 6,669 |
| 81 | `triton-inference-config` | [triton-inference-config](#skill-triton-inference-config) | 2,350 |
| 82 | `tuning-hyperparameters` | [tuning-hyperparameters](#skill-tuning-hyperparameters) | 4,763 |
| 83 | `twinmind-data-handling` | [twinmind-data-handling](#skill-twinmind-data-handling) | 3,813 |
| 84 | `twinmind-debug-bundle` | [twinmind-debug-bundle](#skill-twinmind-debug-bundle) | 10,778 |
| 85 | `twinmind-performance-tuning` | [twinmind-performance-tuning](#skill-twinmind-performance-tuning) | 3,848 |
| 86 | `twinmind-reference-architecture` | [twinmind-reference-architecture](#skill-twinmind-reference-architecture) | 3,924 |
| 87 | `typeorm-entity-generator` | [typeorm-entity-generator](#skill-typeorm-entity-generator) | 2,420 |
| 88 | `uniprot-database` | [uniprot-database](#skill-uniprot-database) | 7,334 |
| 89 | `unit-testing-test-generate` | [unit-testing-test-generate](#skill-unit-testing-test-generate) | 11,425 |
| 90 | `unittest-test-creator` | [unittest-test-creator](#skill-unittest-test-creator) | 2,322 |
| 91 | `us-property-data` | [us-property-data](#skill-us-property-data) | 6,895 |
| 92 | `v3-ddd-architecture` | [v3-ddd-architecture](#skill-v3-ddd-architecture) | 12,607 |
| 93 | `v3-mcp-optimization` | [v3-mcp-optimization](#skill-v3-mcp-optimization) | 22,204 |
| 94 | `v3-performance-optimization` | [v3-performance-optimization](#skill-v3-performance-optimization) | 11,828 |
| 95 | `validating-database-integrity` | [validating-database-integrity](#skill-validating-database-integrity) | 7,902 |
| 96 | `validator-expert` | [validator-expert](#skill-validator-expert) | 7,571 |
| 97 | `vastai-data-handling` | [vastai-data-handling](#skill-vastai-data-handling) | 6,059 |
| 98 | `vastai-debug-bundle` | [vastai-debug-bundle](#skill-vastai-debug-bundle) | 4,856 |
| 99 | `vastai-performance-tuning` | [vastai-performance-tuning](#skill-vastai-performance-tuning) | 5,855 |
| 100 | `vastai-reference-architecture` | [vastai-reference-architecture](#skill-vastai-reference-architecture) | 6,858 |
| 101 | `vector-database-engineer` | [vector-database-engineer](#skill-vector-database-engineer) | 2,696 |
| 102 | `veeva-data-handling` | [veeva-data-handling](#skill-veeva-data-handling) | 1,209 |
| 103 | `veeva-debug-bundle` | [veeva-debug-bundle](#skill-veeva-debug-bundle) | 1,942 |
| 104 | `veeva-performance-tuning` | [veeva-performance-tuning](#skill-veeva-performance-tuning) | 1,972 |
| 105 | `veeva-reference-architecture` | [veeva-reference-architecture](#skill-veeva-reference-architecture) | 1,992 |
| 106 | `vercel-architecture-variants` | [vercel-architecture-variants](#skill-vercel-architecture-variants) | 8,635 |
| 107 | `vercel-data-handling` | [vercel-data-handling](#skill-vercel-data-handling) | 8,098 |
| 108 | `vercel-debug-bundle` | [vercel-debug-bundle](#skill-vercel-debug-bundle) | 6,383 |
| 109 | `vercel-performance-tuning` | [vercel-performance-tuning](#skill-vercel-performance-tuning) | 8,162 |
| 110 | `vercel-reference-architecture` | [vercel-reference-architecture](#skill-vercel-reference-architecture) | 9,412 |
| 111 | `verify-changes` | [verify-changes](#skill-verify-changes) | 4,066 |
| 112 | `verify-ui-change` | [verify-ui-change](#skill-verify-ui-change) | 5,265 |
| 113 | `verify-unattended` | [verify-unattended](#skill-verify-unattended) | 7,348 |
| 114 | `vertex-agent-builder` | [vertex-agent-builder](#skill-vertex-agent-builder) | 3,685 |
| 115 | `vertex-ai-deployer` | [vertex-ai-deployer](#skill-vertex-ai-deployer) | 2,310 |
| 116 | `vertex-engine-inspector` | [vertex-engine-inspector](#skill-vertex-engine-inspector) | 6,851 |
| 117 | `visualization-best-practices` | [visualization-best-practices](#skill-visualization-best-practices) | 2,449 |
| 118 | `vitest-skill` | [vitest-skill](#skill-vitest-skill) | 4,977 |
| 119 | `vitest-test-creator` | [vitest-test-creator](#skill-vitest-test-creator) | 2,296 |
| 120 | `vulnerability-scanner` | [vulnerability-scanner](#skill-vulnerability-scanner) | 7,988 |
| 121 | `wait-what` | [wait-what](#skill-wait-what) | 401 |
| 122 | `wandb-experiment-logger` | [wandb-experiment-logger](#skill-wandb-experiment-logger) | 2,379 |
| 123 | `wayfinder` | [wayfinder](#skill-wayfinder) | 12,036 |
| 124 | `web-design-guidelines` | [web-design-guidelines](#skill-web-design-guidelines) | 2,006 |
| 125 | `web-performance-optimization` | [web-performance-optimization](#skill-web-performance-optimization) | 17,104 |
| 126 | `web-security-testing` | [web-security-testing](#skill-web-security-testing) | 4,506 |
| 127 | `web3-testing` | [web3-testing](#skill-web3-testing) | 11,822 |
| 128 | `webapp-testing` | [webapp-testing](#skill-webapp-testing) | 4,138 |
| 129 | `webflow-data-handling` | [webflow-data-handling](#skill-webflow-data-handling) | 10,034 |
| 130 | `webflow-debug-bundle` | [webflow-debug-bundle](#skill-webflow-debug-bundle) | 9,215 |
| 131 | `webflow-performance-tuning` | [webflow-performance-tuning](#skill-webflow-performance-tuning) | 8,612 |
| 132 | `webflow-reference-architecture` | [webflow-reference-architecture](#skill-webflow-reference-architecture) | 13,384 |
| 133 | `websocket-handler-setup` | [websocket-handler-setup](#skill-websocket-handler-setup) | 2,409 |
| 134 | `window-function-generator` | [window-function-generator](#skill-window-function-generator) | 2,401 |
| 135 | `windows-shell-reliability` | [windows-shell-reliability](#skill-windows-shell-reliability) | 4,150 |
| 136 | `windsurf-api-development` | [windsurf-api-development](#skill-windsurf-api-development) | 2,069 |
| 137 | `windsurf-architecture-variants` | [windsurf-architecture-variants](#skill-windsurf-architecture-variants) | 7,408 |
| 138 | `windsurf-audit-logging` | [windsurf-audit-logging](#skill-windsurf-audit-logging) | 1,925 |
| 139 | `windsurf-cascade-agents` | [windsurf-cascade-agents](#skill-windsurf-cascade-agents) | 2,131 |
| 140 | `windsurf-cascade-context` | [windsurf-cascade-context](#skill-windsurf-cascade-context) | 2,069 |
| 141 | `windsurf-cascade-onboarding` | [windsurf-cascade-onboarding](#skill-windsurf-cascade-onboarding) | 2,182 |
| 142 | `windsurf-cicd-github-actions` | [windsurf-cicd-github-actions](#skill-windsurf-cicd-github-actions) | 2,072 |
| 143 | `windsurf-code-completion` | [windsurf-code-completion](#skill-windsurf-code-completion) | 2,030 |
| 144 | `windsurf-code-privacy` | [windsurf-code-privacy](#skill-windsurf-code-privacy) | 1,929 |
| 145 | `windsurf-custom-prompts` | [windsurf-custom-prompts](#skill-windsurf-custom-prompts) | 1,979 |
| 146 | `windsurf-data-handling` | [windsurf-data-handling](#skill-windsurf-data-handling) | 7,108 |
| 147 | `windsurf-debug-bundle` | [windsurf-debug-bundle](#skill-windsurf-debug-bundle) | 5,992 |
| 148 | `windsurf-debugging-ai` | [windsurf-debugging-ai](#skill-windsurf-debugging-ai) | 1,866 |
| 149 | `windsurf-dependency-management` | [windsurf-dependency-management](#skill-windsurf-dependency-management) | 2,107 |
| 150 | `windsurf-dockerfile-generation` | [windsurf-dockerfile-generation](#skill-windsurf-dockerfile-generation) | 2,100 |
| 151 | `windsurf-enterprise-sso` | [windsurf-enterprise-sso](#skill-windsurf-enterprise-sso) | 1,963 |
| 152 | `windsurf-extension-pack` | [windsurf-extension-pack](#skill-windsurf-extension-pack) | 2,096 |
| 153 | `windsurf-flows-automation` | [windsurf-flows-automation](#skill-windsurf-flows-automation) | 2,018 |
| 154 | `windsurf-git-integration` | [windsurf-git-integration](#skill-windsurf-git-integration) | 1,983 |
| 155 | `windsurf-keyboard-shortcuts` | [windsurf-keyboard-shortcuts](#skill-windsurf-keyboard-shortcuts) | 1,999 |
| 156 | `windsurf-license-management` | [windsurf-license-management](#skill-windsurf-license-management) | 2,039 |
| 157 | `windsurf-linting-config` | [windsurf-linting-config](#skill-windsurf-linting-config) | 2,005 |
| 158 | `windsurf-mcp-integration` | [windsurf-mcp-integration](#skill-windsurf-mcp-integration) | 2,098 |
| 159 | `windsurf-multi-file-editing` | [windsurf-multi-file-editing](#skill-windsurf-multi-file-editing) | 2,204 |
| 160 | `windsurf-performance-profiling` | [windsurf-performance-profiling](#skill-windsurf-performance-profiling) | 2,039 |
| 161 | `windsurf-performance-tuning` | [windsurf-performance-tuning](#skill-windsurf-performance-tuning) | 6,451 |
| 162 | `windsurf-refactoring-large` | [windsurf-refactoring-large](#skill-windsurf-refactoring-large) | 2,197 |
| 163 | `windsurf-reference-architecture` | [windsurf-reference-architecture](#skill-windsurf-reference-architecture) | 9,587 |
| 164 | `windsurf-release-automation` | [windsurf-release-automation](#skill-windsurf-release-automation) | 2,081 |
| 165 | `windsurf-team-settings` | [windsurf-team-settings](#skill-windsurf-team-settings) | 1,950 |
| 166 | `windsurf-terminal-ai` | [windsurf-terminal-ai](#skill-windsurf-terminal-ai) | 1,945 |
| 167 | `windsurf-test-generation` | [windsurf-test-generation](#skill-windsurf-test-generation) | 2,073 |
| 168 | `windsurf-theme-customization` | [windsurf-theme-customization](#skill-windsurf-theme-customization) | 1,956 |
| 169 | `windsurf-usage-analytics` | [windsurf-usage-analytics](#skill-windsurf-usage-analytics) | 1,881 |
| 170 | `windsurf-workspace-setup` | [windsurf-workspace-setup](#skill-windsurf-workspace-setup) | 2,080 |
| 171 | `wizard` | [wizard](#skill-wizard) | 4,167 |
| 172 | `wjttc-tester` | [wjttc-tester](#skill-wjttc-tester) | 8,946 |
| 173 | `wordpress-penetration-testing` | [wordpress-penetration-testing](#skill-wordpress-penetration-testing) | 16,773 |
| 174 | `worker-benchmarks` | [worker-benchmarks](#skill-worker-benchmarks) | 4,386 |
| 175 | `workhuman-debug-bundle` | [workhuman-debug-bundle](#skill-workhuman-debug-bundle) | 2,060 |
| 176 | `workhuman-performance-tuning` | [workhuman-performance-tuning](#skill-workhuman-performance-tuning) | 2,090 |
| 177 | `workhuman-reference-architecture` | [workhuman-reference-architecture](#skill-workhuman-reference-architecture) | 2,113 |
| 178 | `writing-beats` | [writing-beats](#skill-writing-beats) | 4,922 |
| 179 | `writing-for-agents` | [writing-for-agents](#skill-writing-for-agents) | 10,967 |
| 180 | `writing-fragments` | [writing-fragments](#skill-writing-fragments) | 3,637 |
| 181 | `writing-shape` | [writing-shape](#skill-writing-shape) | 6,001 |
| 182 | `xss-html-injection` | [xss-html-injection](#skill-xss-html-injection) | 14,935 |
| 183 | `yaml-config-validator` | [yaml-config-validator](#skill-yaml-config-validator) | 2,323 |
| 184 | `yaml-master` | [yaml-master](#skill-yaml-master) | 2,685 |
| 185 | `zigzag-pattern-classifier` | [zigzag-pattern-classifier](#skill-zigzag-pattern-classifier) | 13,044 |
...
# [1/185] SKILL: supabase-performance-tuning

- **Source File:** `skills/supabase-performance-tuning.md`
- **Original Size:** 13,099 bytes
- [Back to Volume Index](#master-trading-skills---volume-6-of-6)
...
# [2/185] SKILL: supabase-reference-architecture
...
# [3/185] SKILL: swift-protocol-di-testing
...
```markdown
*** START OF SKILL: swift-protocol-di-testing.md ***
```
...
```markdown
*** END OF SKILL: swift-protocol-di-testing.md ***
```
...
# [4/185] SKILL: swiftui-performance-audit
...
```markdown
*** START OF SKILL: swiftui-performance-audit.md ***
```
...
```markdown
*** END OF SKILL: swiftui-performance-audit.md ***
```
...
# [5/185] SKILL: swiftui-view-refactor
...
```markdown
*** START OF SKILL: swiftui-view-refactor.md ***
```
...
```markdown
*** END OF SKILL: swiftui-view-refactor.md ***
```
...
```markdown
*** START OF SKILL: sync-profiles.md ***
```
...
# [8/185] SKILL: systematic-debugging
...
```markdown
*** START OF SKILL: tailwind-patterns.md ***
```
...
```markdown
*** END OF SKILL: tailwind-patterns.md ***
```
...
```markdown
*** START OF SKILL: tdd-workflow.md ***
```
...
# [13/185] SKILL: tdd-workflows-tdd-cycle
...
# [14/185] SKILL: tdd-workflows-tdd-green
...
```markdown
*** START OF SKILL: tdd-workflows-tdd-green.md ***
```
...
```markdown
*** END OF SKILL: tdd-workflows-tdd-green.md ***
```
...
# [15/185] SKILL: tdd-workflows-tdd-red
...
```markdown
*** START OF SKILL: tdd-workflows-tdd-red.md ***
```
...
```markdown
*** END OF SKILL: tdd-workflows-tdd-red.md ***
```
...
# [16/185] SKILL: tdd-workflows-tdd-refactor
...
```markdown
*** START OF SKILL: tdd-workflows-tdd-refactor.md ***
```
...
```markdown
*** END OF SKILL: tdd-workflows-tdd-refactor.md ***
```
...
```markdown
*** START OF SKILL: tdd-workflows.md ***
```
...
# [20/185] SKILL: techsmith-debug-bundle
...
```markdown
*** START OF SKILL: techsmith-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: techsmith-debug-bundle.md ***
```
...
# [21/185] SKILL: techsmith-performance-tuning
...
```markdown
*** START OF SKILL: techsmith-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: techsmith-performance-tuning.md ***
```
...
# [22/185] SKILL: techsmith-reference-architecture
...
```markdown
*** START OF SKILL: techsmith-reference-architecture.md ***
```
...
```markdown
*** END OF SKILL: techsmith-reference-architecture.md ***
```
...
# [23/185] SKILL: temporal-python-pro
...
# [24/185] SKILL: temporal-python-testing
...
```markdown
*** START OF SKILL: temporal-python-testing.md ***
```
...
```markdown
*** END OF SKILL: temporal-python-testing.md ***
```
...
# [25/185] SKILL: tensorboard-visualizer
...
```markdown
*** START OF SKILL: tensorboard-visualizer.md ***
```
...
```markdown
*** END OF SKILL: tensorboard-visualizer.md ***
```
...
# [26/185] SKILL: tensorflow-model-trainer
...
# [27/185] SKILL: tensorflow-savedmodel-creator
...
# [28/185] SKILL: tensorflow-serving-setup
...
```markdown
*** START OF SKILL: tensorflow-serving-setup.md ***
```
...
```markdown
*** END OF SKILL: tensorflow-serving-setup.md ***
```
...
# [29/185] SKILL: terraform-state-manager
...
```markdown
*** START OF SKILL: terraform-state-manager.md ***
```
...
```markdown
*** END OF SKILL: terraform-state-manager.md ***
```
...
```markdown
*** START OF SKILL: test-automator.md ***
```
...
```markdown
*** END OF SKILL: test-automator.md ***
```
...
# [31/185] SKILL: test-data-builder
...
```markdown
*** START OF SKILL: test-data-builder.md ***
```
...
```markdown
*** END OF SKILL: test-data-builder.md ***
```
...
# [32/185] SKILL: test-driven-development
...
```markdown
*** START OF SKILL: test-driven-development.md ***
```
...
```markdown
*** END OF SKILL: test-driven-development.md ***
```
...
# [33/185] SKILL: test-error-states
...
```markdown
*** START OF SKILL: test-error-states.md ***
```
...
```markdown
*** END OF SKILL: test-error-states.md ***
```
...
# [35/185] SKILL: test-framework-migration-skill
...
```markdown
*** START OF SKILL: test-framework-migration-skill.md ***
```
...
```markdown
*** END OF SKILL: test-framework-migration-skill.md ***
```
...
# [38/185] SKILL: test-naming-enforcer
...
```markdown
*** START OF SKILL: test-naming-enforcer.md ***
```
...
```markdown
*** END OF SKILL: test-naming-enforcer.md ***
```
...
# [39/185] SKILL: test-organization-helper
...
```markdown
*** START OF SKILL: test-organization-helper.md ***
```
...
```markdown
*** END OF SKILL: test-organization-helper.md ***
```
...
# [40/185] SKILL: test-parallelizer
...
```markdown
*** START OF SKILL: test-parallelizer.md ***
```
...
```markdown
*** END OF SKILL: test-parallelizer.md ***
```
...
# [41/185] SKILL: test-retry-config
...
```markdown
*** START OF SKILL: test-retry-config.md ***
```
...
```markdown
*** END OF SKILL: test-retry-config.md ***
```
...
# [43/185] SKILL: testing-browser-compatibility
...
```markdown
*** START OF SKILL: testing-browser-compatibility.md ***
```
...
```markdown
*** END OF SKILL: testing-browser-compatibility.md ***
```
...
# [44/185] SKILL: testing-load-balancers
...
```markdown
*** START OF SKILL: testing-load-balancers.md ***
```
...
```markdown
*** END OF SKILL: testing-load-balancers.md ***
```
...
# [45/185] SKILL: testing-mobile-apps
...
```markdown
*** START OF SKILL: testing-mobile-apps.md ***
```
...
```markdown
*** END OF SKILL: testing-mobile-apps.md ***
```
...
```markdown
*** START OF SKILL: testing-patterns.md ***
```
...
```markdown
*** END OF SKILL: testing-patterns.md ***
```
...
# [48/185] SKILL: testing-visual-regression
...
```markdown
*** START OF SKILL: testng-skill.md ***
```
...
# [50/185] SKILL: thread-dump-analyzer
...
```markdown
*** START OF SKILL: thread-dump-analyzer.md ***
```
...
```markdown
*** END OF SKILL: thread-dump-analyzer.md ***
```
...
```markdown
*** START OF SKILL: threat-detection.md ***
```
...
```markdown
*** END OF SKILL: threat-detection.md ***
```
...
# [52/185] SKILL: throughput-calculator
...
```markdown
*** START OF SKILL: throughput-calculator.md ***
```
...
```markdown
*** END OF SKILL: throughput-calculator.md ***
```
...
# [53/185] SKILL: time-series-decomposer
...
```markdown
*** START OF SKILL: to-questionnaire.md ***
```
...
```markdown
*** END OF SKILL: to-questionnaire.md ***
```
...
# [57/185] SKILL: together-debug-bundle
...
```markdown
*** START OF SKILL: together-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: together-debug-bundle.md ***
```
...
# [58/185] SKILL: together-performance-tuning
...
```markdown
*** START OF SKILL: together-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: together-performance-tuning.md ***
```
...
# [59/185] SKILL: together-reference-architecture
...
```markdown
*** START OF SKILL: together-reference-architecture.md ***
```
...
```markdown
*** END OF SKILL: together-reference-architecture.md ***
```
...
# [60/185] SKILL: torchscript-exporter
...
```markdown
*** START OF SKILL: torchscript-exporter.md ***
```
...
```markdown
*** END OF SKILL: torchscript-exporter.md ***
```
...
# [61/185] SKILL: torchserve-config-generator
...
```markdown
*** START OF SKILL: torchserve-config-generator.md ***
```
...
```markdown
*** END OF SKILL: torchserve-config-generator.md ***
```
...
# [63/185] SKILL: tracing-transitive-vulnerabilities
...
```markdown
*** START OF SKILL: tracing-transitive-vulnerabilities.md ***
```
...
```markdown
*** END OF SKILL: tracing-transitive-vulnerabilities.md ***
```
...
# [64/185] SKILL: tracking-application-response-times
...
```markdown
*** START OF SKILL: tracking-application-response-times.md ***
```
...
```markdown
*** END OF SKILL: tracking-application-response-times.md ***
```
...
# [65/185] SKILL: tracking-model-versions
...
# [66/185] SKILL: tracking-regression-tests
...
# [67/185] SKILL: tracking-resource-usage
...
```markdown
*** START OF SKILL: tracking-resource-usage.md ***
```
...
```markdown
*** END OF SKILL: tracking-resource-usage.md ***
```
...
# [68/185] SKILL: tracking-service-reliability
...
```markdown
*** START OF SKILL: tracking-service-reliability.md ***
```
...
```markdown
*** END OF SKILL: tracking-service-reliability.md ***
```
...
# [70/185] SKILL: trader-cloud-backtest
...
# [72/185] SKILL: trader-portfolio-cg
...
# [78/185] SKILL: train-test-splitter
...
```markdown
*** START OF SKILL: train-test-splitter.md ***
```
...
```markdown
*** END OF SKILL: train-test-splitter.md ***
```
...
# [79/185] SKILL: training-machine-learning-models
...
# [81/185] SKILL: triton-inference-config
...
```markdown
*** START OF SKILL: triton-inference-config.md ***
```
...
```markdown
*** END OF SKILL: triton-inference-config.md ***
```
...
# [82/185] SKILL: tuning-hyperparameters
...
# [83/185] SKILL: twinmind-data-handling
...
```markdown
*** START OF SKILL: twinmind-data-handling.md ***
```
...
```markdown
*** END OF SKILL: twinmind-data-handling.md ***
```
...
# [84/185] SKILL: twinmind-debug-bundle
...
```markdown
*** START OF SKILL: twinmind-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: twinmind-debug-bundle.md ***
```
...
# [85/185] SKILL: twinmind-performance-tuning
...
```markdown
*** START OF SKILL: twinmind-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: twinmind-performance-tuning.md ***
```
...
# [86/185] SKILL: twinmind-reference-architecture
...
```markdown
*** START OF SKILL: twinmind-reference-architecture.md ***
```
...
```markdown
*** END OF SKILL: twinmind-reference-architecture.md ***
```
...
# [87/185] SKILL: typeorm-entity-generator
...
```markdown
*** START OF SKILL: typeorm-entity-generator.md ***
```
...
```markdown
*** END OF SKILL: typeorm-entity-generator.md ***
```
...
```markdown
*** START OF SKILL: uniprot-database.md ***
```
...
```markdown
*** END OF SKILL: uniprot-database.md ***
```
...
# [89/185] SKILL: unit-testing-test-generate
...
```markdown
*** START OF SKILL: unit-testing-test-generate.md ***
```
...
```markdown
*** END OF SKILL: unit-testing-test-generate.md ***
```
...
# [90/185] SKILL: unittest-test-creator
...
```markdown
*** START OF SKILL: unittest-test-creator.md ***
```
...
```markdown
*** END OF SKILL: unittest-test-creator.md ***
```
...
```markdown
*** START OF SKILL: us-property-data.md ***
```
...
```markdown
*** END OF SKILL: us-property-data.md ***
```
...
# [92/185] SKILL: v3-ddd-architecture
...
# [93/185] SKILL: v3-mcp-optimization
...
```markdown
*** START OF SKILL: v3-mcp-optimization.md ***
```
...
```markdown
*** END OF SKILL: v3-mcp-optimization.md ***
```
...
# [94/185] SKILL: v3-performance-optimization
...
# [95/185] SKILL: validating-database-integrity
...
```markdown
*** START OF SKILL: validating-database-integrity.md ***
```
...
```markdown
*** END OF SKILL: validating-database-integrity.md ***
```
...
```markdown
*** START OF SKILL: validator-expert.md ***
```
...
```markdown
*** END OF SKILL: validator-expert.md ***
```
...
# [97/185] SKILL: vastai-data-handling
...
```markdown
*** START OF SKILL: vastai-data-handling.md ***
```
...
```markdown
*** END OF SKILL: vastai-data-handling.md ***
```
...
# [98/185] SKILL: vastai-debug-bundle
...
```markdown
*** START OF SKILL: vastai-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: vastai-debug-bundle.md ***
```
...
# [99/185] SKILL: vastai-performance-tuning
...
```markdown
*** START OF SKILL: vastai-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: vastai-performance-tuning.md ***
```
...
# [100/185] SKILL: vastai-reference-architecture
...
```markdown
*** START OF SKILL: vastai-reference-architecture.md ***
```
...
```markdown
*** END OF SKILL: vastai-reference-architecture.md ***
```
...
# [101/185] SKILL: vector-database-engineer
...
```markdown
*** START OF SKILL: vector-database-engineer.md ***
```
...
```markdown
*** END OF SKILL: vector-database-engineer.md ***
```
...
# [102/185] SKILL: veeva-data-handling
...
```markdown
*** START OF SKILL: veeva-data-handling.md ***
```
...
```markdown
*** END OF SKILL: veeva-data-handling.md ***
```
...
# [103/185] SKILL: veeva-debug-bundle
...
```markdown
*** START OF SKILL: veeva-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: veeva-debug-bundle.md ***
```
...
# [104/185] SKILL: veeva-performance-tuning
...
```markdown
*** START OF SKILL: veeva-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: veeva-performance-tuning.md ***
```
...
# [105/185] SKILL: veeva-reference-architecture
...
```markdown
*** START OF SKILL: veeva-reference-architecture.md ***
```
...
```markdown
*** END OF SKILL: veeva-reference-architecture.md ***
```
...
# [106/185] SKILL: vercel-architecture-variants
...
```markdown
*** START OF SKILL: vercel-architecture-variants.md ***
```
...
```markdown
*** END OF SKILL: vercel-architecture-variants.md ***
```
...
# [107/185] SKILL: vercel-data-handling
...
```markdown
*** START OF SKILL: vercel-data-handling.md ***
```
...
```markdown
*** END OF SKILL: vercel-data-handling.md ***
```
...
# [108/185] SKILL: vercel-debug-bundle
...
```markdown
*** START OF SKILL: vercel-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: vercel-debug-bundle.md ***
```
...
# [109/185] SKILL: vercel-performance-tuning
...
```markdown
*** START OF SKILL: vercel-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: vercel-performance-tuning.md ***
```
...
# [110/185] SKILL: vercel-reference-architecture
...
```markdown
*** START OF SKILL: verify-changes.md ***
```
...
```markdown
*** END OF SKILL: verify-changes.md ***
```
...
# [112/185] SKILL: verify-ui-change
...
```markdown
*** START OF SKILL: verify-ui-change.md ***
```
...
```markdown
*** END OF SKILL: verify-ui-change.md ***
```
...
# [113/185] SKILL: verify-unattended
...
```markdown
*** START OF SKILL: verify-unattended.md ***
```
...
```markdown
*** END OF SKILL: verify-unattended.md ***
```
...
# [114/185] SKILL: vertex-agent-builder
...
```markdown
*** START OF SKILL: vertex-agent-builder.md ***
```
...
```markdown
*** END OF SKILL: vertex-agent-builder.md ***
```
...
# [115/185] SKILL: vertex-ai-deployer
...
```markdown
*** START OF SKILL: vertex-ai-deployer.md ***
```
...
```markdown
*** END OF SKILL: vertex-ai-deployer.md ***
```
...
# [116/185] SKILL: vertex-engine-inspector
...
```markdown
*** START OF SKILL: vertex-engine-inspector.md ***
```
...
```markdown
*** END OF SKILL: vertex-engine-inspector.md ***
```
...
# [117/185] SKILL: visualization-best-practices
...
```markdown
*** START OF SKILL: visualization-best-practices.md ***
```
...
```markdown
*** END OF SKILL: visualization-best-practices.md ***
```
...
```markdown
*** START OF SKILL: vitest-skill.md ***
```
...
# [119/185] SKILL: vitest-test-creator
...
```markdown
*** START OF SKILL: vitest-test-creator.md ***
```
...
```markdown
*** END OF SKILL: vitest-test-creator.md ***
```
...
# [120/185] SKILL: vulnerability-scanner
...
```markdown
*** START OF SKILL: vulnerability-scanner.md ***
```
...
```markdown
*** END OF SKILL: vulnerability-scanner.md ***
```
...
# [122/185] SKILL: wandb-experiment-logger
...
```markdown
*** START OF SKILL: wandb-experiment-logger.md ***
```
...
```markdown
*** END OF SKILL: wandb-experiment-logger.md ***
```
...
# [124/185] SKILL: web-design-guidelines
...
```markdown
*** START OF SKILL: web-design-guidelines.md ***
```
...
```markdown
*** END OF SKILL: web-design-guidelines.md ***
```
...
# [125/185] SKILL: web-performance-optimization
...
# [126/185] SKILL: web-security-testing
...
```markdown
*** START OF SKILL: web-security-testing.md ***
```
...
```markdown
*** END OF SKILL: web-security-testing.md ***
```
...
```markdown
*** START OF SKILL: web3-testing.md ***
```
...
```markdown
*** START OF SKILL: webapp-testing.md ***
```
...
```markdown
*** END OF SKILL: webapp-testing.md ***
```
...
# [129/185] SKILL: webflow-data-handling
...
```markdown
*** START OF SKILL: webflow-data-handling.md ***
```
...
```markdown
*** END OF SKILL: webflow-data-handling.md ***
```
...
# [130/185] SKILL: webflow-debug-bundle
...
```markdown
*** START OF SKILL: webflow-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: webflow-debug-bundle.md ***
```
...
# [131/185] SKILL: webflow-performance-tuning
...
```markdown
*** START OF SKILL: webflow-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: webflow-performance-tuning.md ***
```
...
# [132/185] SKILL: webflow-reference-architecture
...
```markdown
*** START OF SKILL: webflow-reference-architecture.md ***
```
...
```markdown
*** END OF SKILL: webflow-reference-architecture.md ***
```
...
# [133/185] SKILL: websocket-handler-setup
...
```markdown
*** START OF SKILL: websocket-handler-setup.md ***
```
...
```markdown
*** END OF SKILL: websocket-handler-setup.md ***
```
...
# [134/185] SKILL: window-function-generator
...
```markdown
*** START OF SKILL: window-function-generator.md ***
```
...
```markdown
*** END OF SKILL: window-function-generator.md ***
```
...
# [135/185] SKILL: windows-shell-reliability
...
```markdown
*** START OF SKILL: windows-shell-reliability.md ***
```
...
```markdown
*** END OF SKILL: windows-shell-reliability.md ***
```
...
# [136/185] SKILL: windsurf-api-development
...
```markdown
*** START OF SKILL: windsurf-api-development.md ***
```
...
```markdown
*** END OF SKILL: windsurf-api-development.md ***
```
...
# [137/185] SKILL: windsurf-architecture-variants
...
```markdown
*** START OF SKILL: windsurf-architecture-variants.md ***
```
...
```markdown
*** END OF SKILL: windsurf-architecture-variants.md ***
```
...
# [138/185] SKILL: windsurf-audit-logging
...
```markdown
*** START OF SKILL: windsurf-audit-logging.md ***
```
...
```markdown
*** END OF SKILL: windsurf-audit-logging.md ***
```
...
# [139/185] SKILL: windsurf-cascade-agents
...
```markdown
*** START OF SKILL: windsurf-cascade-agents.md ***
```
...
```markdown
*** END OF SKILL: windsurf-cascade-agents.md ***
```
...
# [140/185] SKILL: windsurf-cascade-context
...
```markdown
*** START OF SKILL: windsurf-cascade-context.md ***
```
...
```markdown
*** END OF SKILL: windsurf-cascade-context.md ***
```
...
# [141/185] SKILL: windsurf-cascade-onboarding
...
```markdown
*** START OF SKILL: windsurf-cascade-onboarding.md ***
```
...
```markdown
*** END OF SKILL: windsurf-cascade-onboarding.md ***
```
...
# [142/185] SKILL: windsurf-cicd-github-actions
...
```markdown
*** START OF SKILL: windsurf-cicd-github-actions.md ***
```
...
```markdown
*** END OF SKILL: windsurf-cicd-github-actions.md ***
```
...
# [143/185] SKILL: windsurf-code-completion
...
```markdown
*** START OF SKILL: windsurf-code-completion.md ***
```
...
```markdown
*** END OF SKILL: windsurf-code-completion.md ***
```
...
# [144/185] SKILL: windsurf-code-privacy
...
```markdown
*** START OF SKILL: windsurf-code-privacy.md ***
```
...
```markdown
*** END OF SKILL: windsurf-code-privacy.md ***
```
...
# [145/185] SKILL: windsurf-custom-prompts
...
```markdown
*** START OF SKILL: windsurf-custom-prompts.md ***
```
...
```markdown
*** END OF SKILL: windsurf-custom-prompts.md ***
```
...
# [146/185] SKILL: windsurf-data-handling
...
```markdown
*** START OF SKILL: windsurf-data-handling.md ***
```
...
```markdown
*** END OF SKILL: windsurf-data-handling.md ***
```
...
# [147/185] SKILL: windsurf-debug-bundle
...
```markdown
*** START OF SKILL: windsurf-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: windsurf-debug-bundle.md ***
```
...
# [148/185] SKILL: windsurf-debugging-ai
...
```markdown
*** START OF SKILL: windsurf-debugging-ai.md ***
```
...
```markdown
*** END OF SKILL: windsurf-debugging-ai.md ***
```
...
# [149/185] SKILL: windsurf-dependency-management
...
```markdown
*** START OF SKILL: windsurf-dependency-management.md ***
```
...
```markdown
*** END OF SKILL: windsurf-dependency-management.md ***
```
...
# [150/185] SKILL: windsurf-dockerfile-generation
...
```markdown
*** START OF SKILL: windsurf-dockerfile-generation.md ***
```
...
```markdown
*** END OF SKILL: windsurf-dockerfile-generation.md ***
```
...
# [151/185] SKILL: windsurf-enterprise-sso
...
```markdown
*** START OF SKILL: windsurf-enterprise-sso.md ***
```
...
```markdown
*** END OF SKILL: windsurf-enterprise-sso.md ***
```
...
# [152/185] SKILL: windsurf-extension-pack
...
```markdown
*** START OF SKILL: windsurf-extension-pack.md ***
```
...
```markdown
*** END OF SKILL: windsurf-extension-pack.md ***
```
...
# [153/185] SKILL: windsurf-flows-automation
...
```markdown
*** START OF SKILL: windsurf-flows-automation.md ***
```
...
```markdown
*** END OF SKILL: windsurf-flows-automation.md ***
```
...
# [154/185] SKILL: windsurf-git-integration
...
```markdown
*** START OF SKILL: windsurf-git-integration.md ***
```
...
```markdown
*** END OF SKILL: windsurf-git-integration.md ***
```
...
# [155/185] SKILL: windsurf-keyboard-shortcuts
...
```markdown
*** START OF SKILL: windsurf-keyboard-shortcuts.md ***
```
...
```markdown
*** END OF SKILL: windsurf-keyboard-shortcuts.md ***
```
...
# [156/185] SKILL: windsurf-license-management
...
```markdown
*** START OF SKILL: windsurf-license-management.md ***
```
...
```markdown
*** END OF SKILL: windsurf-license-management.md ***
```
...
# [157/185] SKILL: windsurf-linting-config
...
```markdown
*** START OF SKILL: windsurf-linting-config.md ***
```
...
```markdown
*** END OF SKILL: windsurf-linting-config.md ***
```
...
# [158/185] SKILL: windsurf-mcp-integration
...
```markdown
*** START OF SKILL: windsurf-mcp-integration.md ***
```
...
```markdown
*** END OF SKILL: windsurf-mcp-integration.md ***
```
...
# [159/185] SKILL: windsurf-multi-file-editing
...
```markdown
*** START OF SKILL: windsurf-multi-file-editing.md ***
```
...
```markdown
*** END OF SKILL: windsurf-multi-file-editing.md ***
```
...
# [160/185] SKILL: windsurf-performance-profiling
...
```markdown
*** START OF SKILL: windsurf-performance-profiling.md ***
```
...
```markdown
*** END OF SKILL: windsurf-performance-profiling.md ***
```
...
# [161/185] SKILL: windsurf-performance-tuning
...
```markdown
*** START OF SKILL: windsurf-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: windsurf-performance-tuning.md ***
```
...
# [162/185] SKILL: windsurf-refactoring-large
...
```markdown
*** START OF SKILL: windsurf-refactoring-large.md ***
```
...
```markdown
*** END OF SKILL: windsurf-refactoring-large.md ***
```
...
# [163/185] SKILL: windsurf-reference-architecture
...
# [164/185] SKILL: windsurf-release-automation
...
```markdown
*** START OF SKILL: windsurf-release-automation.md ***
```
...
```markdown
*** END OF SKILL: windsurf-release-automation.md ***
```
...
# [165/185] SKILL: windsurf-team-settings
...
```markdown
*** START OF SKILL: windsurf-team-settings.md ***
```
...
```markdown
*** END OF SKILL: windsurf-team-settings.md ***
```
...
# [166/185] SKILL: windsurf-terminal-ai
...
```markdown
*** START OF SKILL: windsurf-terminal-ai.md ***
```
...
```markdown
*** END OF SKILL: windsurf-terminal-ai.md ***
```
...
# [167/185] SKILL: windsurf-test-generation
...
```markdown
*** START OF SKILL: windsurf-test-generation.md ***
```
...
```markdown
*** END OF SKILL: windsurf-test-generation.md ***
```
...
# [168/185] SKILL: windsurf-theme-customization
...
```markdown
*** START OF SKILL: windsurf-theme-customization.md ***
```
...
```markdown
*** END OF SKILL: windsurf-theme-customization.md ***
```
...
# [169/185] SKILL: windsurf-usage-analytics
...
```markdown
*** START OF SKILL: windsurf-usage-analytics.md ***
```
...
```markdown
*** END OF SKILL: windsurf-usage-analytics.md ***
```
...
# [170/185] SKILL: windsurf-workspace-setup
...
```markdown
*** START OF SKILL: windsurf-workspace-setup.md ***
```
...
```markdown
*** END OF SKILL: windsurf-workspace-setup.md ***
```
...
```markdown
*** START OF SKILL: wjttc-tester.md ***
```
...
# [173/185] SKILL: wordpress-penetration-testing
...
```markdown
*** START OF SKILL: wordpress-penetration-testing.md ***
```
...
```markdown
*** END OF SKILL: wordpress-penetration-testing.md ***
```
...
# [174/185] SKILL: worker-benchmarks
...
```markdown
*** START OF SKILL: worker-benchmarks.md ***
```
...
```markdown
*** END OF SKILL: worker-benchmarks.md ***
```
...
# [175/185] SKILL: workhuman-debug-bundle
...
```markdown
*** START OF SKILL: workhuman-debug-bundle.md ***
```
...
```markdown
*** END OF SKILL: workhuman-debug-bundle.md ***
```
...
# [176/185] SKILL: workhuman-performance-tuning
...
```markdown
*** START OF SKILL: workhuman-performance-tuning.md ***
```
...
```markdown
*** END OF SKILL: workhuman-performance-tuning.md ***
```
...
# [177/185] SKILL: workhuman-reference-architecture
...
```markdown
*** START OF SKILL: workhuman-reference-architecture.md ***
```
...
```markdown
*** END OF SKILL: workhuman-reference-architecture.md ***
```
...
```markdown
*** START OF SKILL: writing-beats.md ***
```
...
# [179/185] SKILL: writing-for-agents
...
```markdown
*** START OF SKILL: writing-for-agents.md ***
```
...
```markdown
*** END OF SKILL: writing-for-agents.md ***
```
...
# [180/185] SKILL: writing-fragments
...
```markdown
*** START OF SKILL: writing-fragments.md ***
```
...
```markdown
*** END OF SKILL: writing-fragments.md ***
```
...
```markdown
*** START OF SKILL: writing-shape.md ***
```
...
# [182/185] SKILL: xss-html-injection
...
```markdown
*** START OF SKILL: xss-html-injection.md ***
```
...
```markdown
*** END OF SKILL: xss-html-injection.md ***
```
...
# [183/185] SKILL: yaml-config-validator
...
```markdown
*** START OF SKILL: yaml-config-validator.md ***
```
...
```markdown
*** END OF SKILL: yaml-config-validator.md ***
```
...
# [185/185] SKILL: zigzag-pattern-classifier
