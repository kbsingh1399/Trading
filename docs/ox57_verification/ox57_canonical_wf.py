...
ROOT env selects tree (/tmp/ox57_verify or /tmp/ox55_pre). PRE=1 stubs mt5."""
import sys, os
from pathlib import Path
ROOT = Path(os.environ.get("ROOT", "/tmp/ox57_verify"))
...
df.to_csv(f"/tmp/ox57_tests/ox57_canonical_{tag}.csv", index=False)
