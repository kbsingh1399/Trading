"""
================================================================================
20 OOS WALK-FORWARD HARNESS — SMC MARCI ENGINE
================================================================================
"""
...
from Engine.strategy.smc_marci import SMCMarciSimulator, RiskConfig, FrictionConfig
...
def run_walkforward(
    ...
    print("=" * 80)
    print("INSTITUTIONAL WALK-FORWARD HARNESS — SMC MARCI ENGINE")
    print("=" * 80)
    ...
    simulator = SMCMarciSimulator(RiskConfig(), FrictionConfig())
    results = []
    all_trades = []
    total_passed = 0
    total_failed = 0
