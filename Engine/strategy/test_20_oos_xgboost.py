"""
================================================================================
20 OOS WALK-FORWARD HARNESS — ENSEMBLE LIQUIDATION CASCADE
================================================================================
...
Enforces Part 14 Institutional Anti-Lookahead Directives:
  ...
  * NEW: Monte Carlo Simulation to evaluate risk of ruin.
================================================================================
"""
...
from Engine.strategy.xgboost_liquidation_engine import (
    RiskConfig,
    FrictionConfig,
    RatchetConfig,
    FeatureExtractor,
...
def run_walkforward(
    ...
    print("=" * 80)
    print("INSTITUTIONAL WALK-FORWARD HARNESS — ENSEMBLE LIQUIDATION CASCADE")
    print("=" * 80)
    ...
    for w_idx, win in enumerate(oos_windows[:max_windows], start=1):
        ...
        # Strictly test with a real model confidence threshold (0.35)
        sim_res = simulator.run(df_test, p_long, p_short, p_threshold=0.35, liq_threshold=1.2)
...
def main():
    parser = argparse.ArgumentParser(description="Walk-Forward Evaluation of Ensemble Liquidation Engine.")
