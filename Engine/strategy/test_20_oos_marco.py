...
from Engine.strategy.smc_marco import SMCMarcoSimulator, RiskConfig, FrictionConfig
import json
import time

def run_walkforward(parquet_path: Path, windows_json: Path):
    print("=" * 80)
    print("INSTITUTIONAL WALK-FORWARD HARNESS – SMC MARCO ENGINE")
    print("=" * 80)
