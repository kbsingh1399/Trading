"""
================================================================================
20 OOS WALK-FORWARD HARNESS — SMC USMAN NOAH ENGINE
================================================================================
"""
...
from Engine.strategy.smc_usman_noah import SMCUsmanNoahSimulator, RiskConfig, FrictionConfig
...
def run_walkforward(
    ...
    print("=" * 80)
    print("INSTITUTIONAL WALK-FORWARD HARNESS — SMC USMAN NOAH ENGINE")
    print("=" * 80)
    ...
    simulator = SMCUsmanNoahSimulator(RiskConfig(), FrictionConfig())
    results = []
    all_trades = []
    total_passed = 0
    total_failed = 0
